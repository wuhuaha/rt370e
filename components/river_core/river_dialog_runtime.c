    ...
    river_dialog_runtime_cloud_import_t *cloud_import)
{
    ...
    cloud_import->playback_phase_known = snapshot.playback_phase_known;
    cloud_import->playback_phase_kind = snapshot.playback_phase_kind;
