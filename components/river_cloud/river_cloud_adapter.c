...
#define RIVER_CLOUD_XIAOZHI_PLAYBACK_GAIN_NUM 5
#define RIVER_CLOUD_XIAOZHI_PLAYBACK_GAIN_DEN 2
...
static const char *river_cloud_xiaozhi_duplex_fallback_reason(
...
static void river_cloud_xiaozhi_downlink_task(void *arg)
{
    ...
    for (;;) {
        ...
        if (river_playback_service_write((const uint8_t *)g_river_cloud.xiaozhi_downlink_stereo,
            ...
            river_cloud_xiaozhi_finalize_playback_cleared("write_failed");
            river_cloud_xiaozhi_reset_downlink_state();
