...
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_POLL_MS    2U
...
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_START_FRAMES 20U
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_STARTUP_BURST_MAX 10U
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_SEGMENT_START_CAP_FRAMES 40U
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_REBUFFER_START_FRAMES 36U
/*
 ...
 */
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_STARVED_REBUFFER_MS 320U
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_PREFETCH_MARGIN_MS 120U
#define RIVER_CLOUD_XIAOZHI_DOWNLINK_REBUFFER_EXTRA_FRAMES 4U
#define RIVER_CLOUD_XIAOZHI_PLAYBACK_BUFFER_FRAMES 24U
#define RIVER_CLOUD_XIAOZHI_PLAYBACK_BUFFER_FRAMES_FALLBACK 16U
...
/*
 * Let preview warmup spend a bounded short burst to catch up when the uplink
 * task starts slightly late. Keep the normal steady-state drain at 1 frame.
 */
#define RIVER_CLOUD_XIAOZHI_UPLINK_PREVIEW_BURST_MAX 3U
...
typedef enum {
    ...
    RIVER_CLOUD_XIAOZHI_ROUND_CLOSE_SERVER_ENDPOINT = 2
