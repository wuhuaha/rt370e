    ...
    if (gate_eval->reason != context->last_gate_reason) {
        ...
        RIVER_LOGI("webrtc_aecm gate=%s playback=%s/%s error=%s interaction=%s ref_path=%s ref_activity=%s native_ref=%u",
                   ...
                   river_voice_runtime_playback_owner_kind_name(
                       gate_eval->playback_owner_kind),
                   river_voice_runtime_error_kind_name(gate_eval->error_kind),
                   river_voice_runtime_interaction_state_name(
                       gate_eval->interaction_state),
