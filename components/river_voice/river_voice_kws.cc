...
#if defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_BC_RESNET_TINY_V2_INT8_DEBUG)
#include "generated/student_bc_resnet_tiny_v2_int8_model_data.h"
#define RIVER_KWS_MODEL_DATA student_bc_resnet_tiny_v2_int8_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_bc_resnet_tiny_v2_int8_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_bc_resnet_tiny_v2_int8_debug"
...
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_BC_RESNET_NANO_V2_FP32_DEBUG)
#include "generated/student_bc_resnet_nano_v2_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_bc_resnet_nano_v2_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_bc_resnet_nano_v2_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_bc_resnet_nano_v2_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_DSCNN_TINY_V2_FP32_DEBUG)
#include "generated/student_dscnn_tiny_v2_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_dscnn_tiny_v2_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_dscnn_tiny_v2_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_dscnn_tiny_v2_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_dscnn_small_v2_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_dscnn_small_v2_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_CONV_RESNET_ED_NANO_V1_FP32_DEBUG)
#include "generated/student_conv_resnet_ed_nano_v1_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_conv_resnet_ed_nano_v1_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_conv_resnet_ed_nano_v1_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_conv_resnet_ed_nano_v1_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_CONV_RESNET_ED_NANO_CURRENT_TEACHER_A_V2_FP32_DEBUG)
#include "generated/student_conv_resnet_ed_nano_current_teacher_a_v2_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_conv_resnet_ed_nano_current_teacher_a_v2_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_conv_resnet_ed_nano_current_teacher_a_v2_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME \
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_CONV_RESNET_ED_NANO_TEACHER_A_NEW_TARGET_CYCLE24_2S_V1_FP32_DEBUG)
#include "generated/student_conv_resnet_ed_nano_teacher_a_new_target_cycle24_2s_v1_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_conv_resnet_ed_nano_teacher_a_new_target_cycle24_2s_v1_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_conv_resnet_ed_nano_teacher_a_new_target_cycle24_2s_v1_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME \
    "student_conv_resnet_ed_nano_teacher_a_new_target_cycle24_2s_v1_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 201U
#define RIVER_KWS_FEATURE_DB_MIN (0.0f)
#define RIVER_KWS_FEATURE_MEAN (0.0f)
#define RIVER_KWS_FEATURE_STD (1.0f)
#define RIVER_KWS_FMIN_HZ (20.0f)
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_CONV_RESNET_ED_NANO_TEACHER_B_NEW_TARGET_BNT5_V1_FP32_DEBUG)
#include "generated/student_conv_resnet_ed_nano_teacher_b_new_target_bnt5_v1_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_conv_resnet_ed_nano_teacher_b_new_target_bnt5_v1_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_conv_resnet_ed_nano_teacher_b_new_target_bnt5_v1_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME \
    "student_conv_resnet_ed_nano_teacher_b_new_target_bnt5_v1_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_CONV_RESNET_ED_TINY_V1_FP32_DEBUG)
#include "generated/student_conv_resnet_ed_tiny_v1_fp32_model_data.h"
#define RIVER_KWS_MODEL_DATA student_conv_resnet_ed_tiny_v1_fp32_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_conv_resnet_ed_tiny_v1_fp32_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_conv_resnet_ed_tiny_v1_fp32_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_CONV_RESNET_ED_TINY_V1_INT8_DEBUG)
#include "generated/student_conv_resnet_ed_tiny_v1_int8_model_data.h"
#define RIVER_KWS_MODEL_DATA student_conv_resnet_ed_tiny_v1_int8_tflite
#define RIVER_KWS_MODEL_DATA_LEN \
    ((size_t)sizeof(student_conv_resnet_ed_tiny_v1_int8_tflite))
#define RIVER_KWS_MODEL_VARIANT_NAME "student_conv_resnet_ed_tiny_v1_int8_debug"
#define RIVER_KWS_WINDOW_SAMPLES 400U
#define RIVER_KWS_HOP_SAMPLES 160U
#define RIVER_KWS_MEL_BINS 40U
#define RIVER_KWS_FEATURE_FRAMES 101U
...
#define RIVER_KWS_FRONTEND_USE_NATURAL_LOG 1
#define RIVER_KWS_FRONTEND_USE_TFLM_FLOAT_RFFT 1
#elif defined(CONFIG_RIVER_KWS_MODEL_VARIANT_STUDENT_BC_RESNET_TINY_V2_FP32_DEBUG)
...
#ifndef CONFIG_RIVER_KWS_PRE_ROLL_FLUSH_MAX_FRAMES
#define CONFIG_RIVER_KWS_PRE_ROLL_FLUSH_MAX_FRAMES 8
#endif
...
#define RIVER_KWS_PRE_ROLL_FLUSH_MAX_FRAMES \
    ((uint32_t)CONFIG_RIVER_KWS_PRE_ROLL_FLUSH_MAX_FRAMES)
