...
#define CONFIG_RIVER_SILERO_VAD_SPEECH_THRESHOLD_Q15 9000
#endif

#ifndef CONFIG_RIVER_SILERO_VAD_SILENCE_THRESHOLD_Q15
#define CONFIG_RIVER_SILERO_VAD_SILENCE_THRESHOLD_Q15 2500
#endif

#ifndef CONFIG_RIVER_SILERO_VAD_HANGOVER_FRAMES
#define CONFIG_RIVER_SILERO_VAD_HANGOVER_FRAMES 10
#endif
...
extern "C" river_status_t river_voice_detector_silero_open(river_voice_detector_t *detector)
{
    ...
    if (context->audio_input_eval_tensor == NULL ||
